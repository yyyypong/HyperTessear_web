...
import { Ct as mixColorsLinear, P as call, Sn as src_default, Ut as resolveBoundingBox, an as shapeLocalCoords, c as colorSpaceOptions, f as transformColor, g as transformStrokePosition, h as transformPosition, hr as vec2f, in as sdf_exports, l as setColorSpaceMode, ln as strokeMaskFromSdf, n as ShaderContext, p as transformColorSpace, s as createGpuUniformsMap, tt as ellipseSdf, vn as vec4, wt as mixColorsVariants, x as ShapeMask, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/Ellipse-CrQ1XYjx.js
var ellipseShape = src_default.fn([
	vec2f,
	f32,
	f32,
	f32,
	...
	vec2f,
	f32
], ShapeMask)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, radiusX, radiusY, rotation, softness, strokeThickness, strokePosition, uv, aspect) => {
	"use gpu";
	const local = shapeLocalCoords(center, rotation, uv, aspect);
	return strokeMaskFromSdf(ellipseSdf(local.x, local.y, radiusX, radiusY), softness, strokeThickness, strokePosition);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: (params) => {
		...
		const mask = call(ellipseShape, "ellipseShape", [
			uniforms.center,
			uniforms.radiusX,
			uniforms.radiusY,
			uniforms.rotation,
...
//#endregion
//#region node_modules/shaders/dist/react/Ellipse.js
var Ellipse_exports = /* @__PURE__ */ __exportAll({
...
var Ellipse_default = ShaderComponent;
//#endregion
export { Ellipse_exports as n, Ellipse_default as t };
