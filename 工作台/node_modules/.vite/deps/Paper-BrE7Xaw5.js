...
import { C as ZERO, Cn as std_exports, It as paper12, K as curl22, Mt as noise_exports, P as call, Rn as clamp, Sn as src_default, Ut as resolveBoundingBox, _r as vec3f, br as i32, cr as data_exports, hn as unpremultiplyAlpha, hr as vec2f, l as setColorSpaceMode, n as ShaderContext, s as createGpuUniformsMap, vn as vec4, yr as f32 } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/Paper-LfukraJk.js
var paperSurface = src_default.fn([
	vec2f,
	f32,
	f32,
	f32,
	f32,
	f32
], vec3f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, aspect, grainScale, seed, displacement, roughness) => {
	"use gpu";
	const aspectUV = vec2f(__tsover_mul(uv.x, aspect), uv.y);
	const grainFreq = __tsover_mul(grainScale, 6);
	const grainUV = aspectUV.mul(grainFreq).add(seed);
	const disp = curl22(grainUV).mul(displacement).mul(.0025);
	const displacedUV = uv.add(disp);
	const grain = paper12(grainUV, i32(6));
	const brightness = clamp(__tsover_add(1, __tsover_mul(__tsover_sub(grain, .7), __tsover_mul(roughness, 1.2))), 0, 1.5);
	return vec3f(displacedUV.x, displacedUV.y, brightness);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, ctx, convertToTexture }) => {
		...
		const brightness = surface.member("z");
		return vec4(straight.member("rgb").mul(brightness), straight.member("a"));
	}
};
//#endregion
//#region node_modules/shaders/dist/react/Paper.js
var Paper_exports = /* @__PURE__ */ __exportAll({
...
var Paper_default = ShaderComponent;
//#endregion
export { Paper_exports as n, Paper_default as t };
