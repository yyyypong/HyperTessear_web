...
import { C as ZERO, P as call, Sn as src_default, Ut as resolveBoundingBox, cr as data_exports, l as setColorSpaceMode, n as ShaderContext, s as createGpuUniformsMap, vr as vec4f } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/Invert-DDmITZjt.js
var invertColor = src_default.fn([vec4f], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color) => {
	"use gpu";
	return vec4f(__tsover_sub(1, color.x), __tsover_sub(1, color.y), __tsover_sub(1, color.z), color.w);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: ({ childNode }) => {
		...
		return call(invertColor, "invertColor", [childNode]);
	}
};
//#endregion
//#region node_modules/shaders/dist/react/Invert.js
var Invert_exports = /* @__PURE__ */ __exportAll({
...
var Invert_default = ShaderComponent;
//#endregion
export { Invert_exports as n, Invert_default as t };
