...
import { C as ZERO, Cn as std_exports, P as call, Sn as src_default, Ut as resolveBoundingBox, Wn as floor, cr as data_exports, l as setColorSpaceMode, n as ShaderContext, s as createGpuUniformsMap, vr as vec4f, yr as f32 } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/Posterize-Dn-Vv2S1.js
var posterizeColor = src_default.fn([vec4f, f32], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, steps) => {
	"use gpu";
	return vec4f(__tsover_div(floor(__tsover_mul(color.x, steps)), steps), __tsover_div(floor(__tsover_mul(color.y, steps)), steps), __tsover_div(floor(__tsover_mul(color.z, steps)), steps), color.w);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode }) => {
		...
		return call(posterizeColor, "posterizeColor", [childNode, uniforms.intensity]);
	}
};
//#endregion
//#region node_modules/shaders/dist/react/Posterize.js
var Posterize_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Posterize_default
});
...
//#endregion
export { Posterize_exports as n, Posterize_default as t };
