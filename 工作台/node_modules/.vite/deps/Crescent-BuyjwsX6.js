...
var crescentShape = src_default.fn([
	...
	vec2f,
	f32
], ShapeMask)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, radius, innerRatio, offset, rotation, softness, strokeThickness, strokePosition, uv, aspect) => {
	"use gpu";
	const local = shapeLocalCoords(center, rotation, uv, aspect);
	return strokeMaskFromSdf(crescentSdf(local.x, local.y, radius, innerRatio, offset), softness, strokeThickness, strokePosition);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: (params) => {
		...
		const mask = call(crescentShape, "crescentShape", [
			uniforms.center,
			uniforms.radius,
			uniforms.innerRatio,
			uniforms.offset,
...
//#endregion
//#region node_modules/shaders/dist/react/Crescent.js
var Crescent_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Crescent_default
});
...
var Crescent_default = ShaderComponent;
//#endregion
export { Crescent_exports as n, Crescent_default as t };
