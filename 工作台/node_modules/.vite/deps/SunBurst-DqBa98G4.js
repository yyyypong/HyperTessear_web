...
import { Cn as std_exports, Ln as atan2, P as call, Sn as src_default, Tt as mixExpr, Ut as resolveBoundingBox, Zn as pow, a as animatedTime, ar as sqrt, f as transformColor, h as transformPosition, hr as vec2f, ir as smoothstep, l as setColorSpaceMode, n as ShaderContext, rr as sin, s as createGpuUniformsMap, vn as vec4, yr as f32 } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/SunBurst-COsVDZ4e.js
var sunBurstAlpha = src_default.fn([
	vec2f,
	vec2f,
	vec2f,
	f32,
	...
	f32,
	f32
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, viewport, center, rayCount, softness, radius, feather, animTime) => {
	"use gpu";
	...
	const rayMask = pow(__tsover_add(__tsover_mul(sin(__tsover_sub(__tsover_mul(angle, rayCount), animTime)), .5), .5), __tsover_mul(__tsover_div(1, __tsover_add(softness, .05)), .3));
	const falloffStart = __tsover_mul(radius, __tsover_sub(1, feather));
	const outerMask = __tsover_sub(1, smoothstep(falloffStart, radius, dist));
...
//#endregion
//#region node_modules/shaders/dist/react/SunBurst.js
var SunBurst_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => SunBurst_default
});
...
var SunBurst_default = ShaderComponent;
//#endregion
export { SunBurst_exports as n, SunBurst_default as t };
