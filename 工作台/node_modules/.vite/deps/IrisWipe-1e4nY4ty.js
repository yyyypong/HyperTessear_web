...
import { C as ZERO, Cn as std_exports, Kn as length, P as call, Pn as select, Sn as src_default, Ut as resolveBoundingBox, cr as data_exports, d as transformBoolean, h as transformPosition, hr as vec2f, ir as smoothstep, l as setColorSpaceMode, n as ShaderContext, qn as max, s as createGpuUniformsMap, vr as vec4f, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/IrisWipe-BFs5DDSa.js
var irisWipeMask = src_default.fn([
	vec4f,
	vec2f,
	f32,
	vec2f,
	...
	f32,
	f32
], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, uv, aspect, center, progress, feather, invert) => {
	"use gpu";
	...
	let coord = __tsover_div(dist, max(maxDist, 1e-4));
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, ctx }) => {
		if (!childNode) {
			console.error("You must pass a child component into the Iris Wipe shader.");
			return ZERO;
		}
		return call(irisWipeMask, "irisWipeMask", [
			childNode,
			ctx.uv,
			ctx.aspect,
			uniforms.center,
...
//#endregion
//#region node_modules/shaders/dist/react/IrisWipe.js
var IrisWipe_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => IrisWipe_default
});
...
//#endregion
export { IrisWipe_exports as n, IrisWipe_default as t };
