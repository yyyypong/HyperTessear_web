...
import { Cn as std_exports, Fn as abs, P as call, Sn as src_default, Ut as resolveBoundingBox, a as animatedTime, f as transformColor, h as transformPosition, hr as vec2f, ir as smoothstep, l as setColorSpaceMode, n as ShaderContext, rr as sin, s as createGpuUniformsMap, u as transformAngle, vn as vec4, yr as f32, zn as cos } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/SineWave-BGAJyGFr.js
var DEG_TO_RAD = Math.PI / 180;
var TAU = Math.PI * 2;
var sineWaveMask = src_default.fn([
	vec2f,
	vec2f,
	f32,
	vec2f,
	...
	f32,
	f32
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, viewport, angle, position, frequency, amplitude, thickness, softness, animTime) => {
	"use gpu";
	...
	const sineWave = __tsover_mul(sin(waveInput), amplitude);
	const distanceFromWave = abs(__tsover_sub(rotatedY, sineWave));
	const halfThickness = __tsover_mul(thickness, .5);
	const halfSoftness = __tsover_mul(softness, .5);
	return __tsover_sub(1, smoothstep(__tsover_sub(halfThickness, halfSoftness), __tsover_add(halfThickness, halfSoftness), distanceFromWave));
}), {
	v: 1,
	name: void 0,
	ast: {
...
var SineWave_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => SineWave_default
});
...
var SineWave_default = ShaderComponent;
//#endregion
export { SineWave_exports as n, SineWave_default as t };
