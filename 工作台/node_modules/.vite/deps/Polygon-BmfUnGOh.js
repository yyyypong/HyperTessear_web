...
var polygonShape = src_default.fn([
	...
	vec2f,
	f32
], ShapeMask)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, radius, sides, rounding, rotation, softness, strokeThickness, strokePosition, uv, aspect) => {
	"use gpu";
	const local = shapeLocalCoords(center, rotation, uv, aspect);
	return strokeMaskFromSdf(mix(polygonSdf(local.x, local.y, radius, sides), circleSdf(local.x, local.y, radius), rounding), softness, strokeThickness, strokePosition);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: (params) => {
		...
		const mask = call(polygonShape, "polygonShape", [
			uniforms.center,
			uniforms.radius,
			uniforms.sides,
			uniforms.rounding,
...
//#endregion
//#region node_modules/shaders/dist/react/Polygon.js
var Polygon_exports = /* @__PURE__ */ __exportAll({
...
var Polygon_default = ShaderComponent;
//#endregion
export { Polygon_exports as n, Polygon_default as t };
