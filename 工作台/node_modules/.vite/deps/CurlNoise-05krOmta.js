...
import { Cn as std_exports, Hn as exp, Kn as length, Mt as noise_exports, P as call, Sn as src_default, Ut as resolveBoundingBox, a as animatedTime, cr as data_exports, fn as toneAndColorExpr, hr as vec2f, l as setColorSpaceMode, n as ShaderContext, q as curl22z, s as createGpuUniformsMap, yr as f32 } from "./Shader-BPX4e-H3.js";
import { i as noiseToneProps, r as noiseSpeedProp, t as noiseColorProps } from "./noiseColor-CRpf22bk-D1zq796m.js";
//#region node_modules/shaders/dist/core/CurlNoise-BXWYh1Qi.js
var curlNoiseField = src_default.fn([
	vec2f,
	vec2f,
	f32,
	f32,
	f32
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, viewport, scale, seed, animTime) => {
	"use gpu";
	const aspect = __tsover_div(viewport.x, viewport.y);
	const pos = vec2f(__tsover_mul(uv.x, aspect), uv.y).mul(exp(scale)).add(seed);
	return __tsover_div(length(curl22z(pos, __tsover_mul(animTime, .2))), 1.414);
}), {
	v: 1,
	name: void 0,
	ast: {
...
//#endregion
//#region node_modules/shaders/dist/react/CurlNoise.js
var CurlNoise_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => CurlNoise_default
});
...
var CurlNoise_default = ShaderComponent;
//#endregion
export { CurlNoise_exports as n, CurlNoise_default as t };
