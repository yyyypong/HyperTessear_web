...
import { Cn as std_exports, Ct as mixColorsLinear, Fn as abs, Gn as fract, Jn as min, Kn as length, P as call, Pn as select, Sn as src_default, Ut as resolveBoundingBox, Vn as dot, Wn as floor, c as colorSpaceOptions, cr as data_exports, f as transformColor, hr as vec2f, ir as smoothstep, kn as fwidth, l as setColorSpaceMode, n as ShaderContext, or as step, p as transformColorSpace, qn as max, rr as sin, s as createGpuUniformsMap, u as transformAngle, wt as mixColorsVariants, yr as f32, zn as cos } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/Truchet-BxCh_IIp.js
var DEG_TO_RAD = Math.PI / 180;
var truchetHash = src_default.fn([vec2f], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((p) => {
	"use gpu";
	const h = dot(p, vec2f(127.1, 311.7));
	return fract(__tsover_mul(sin(h), 43758.5453));
}), {
	v: 1,
	name: void 0,
	ast: {
...
var truchetField = src_default.fn([
	vec2f,
	vec2f,
	f32,
	f32,
	...
	f32,
	f32
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, viewport, cells, thickness, rotation, softness, seed) => {
	"use gpu";
	...
	const flip = truchetHash(vec2f(__tsover_add(cell.x, seed), __tsover_add(cell.y, seed))) > .5;
	const c1x = select(f32(0), f32(1), flip);
	const c2x = select(f32(1), f32(0), flip);
	const arcDist = min(abs(__tsover_sub(length(vec2f(__tsover_sub(localUV.x, c1x), localUV.y)), .5)), abs(__tsover_sub(length(vec2f(__tsover_sub(localUV.x, c2x), __tsover_sub(localUV.y, 1))), .5)));
	const lineWidth = __tsover_mul(thickness, .005);
	...
	return __tsover_mul(__tsover_sub(1, smoothstep(lo, hi, arcDist)), step(1e-4, lineWidth));
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: (params) => {
		...
		const lineMask = call(truchetField, "truchetField", [
...
//#endregion
//#region node_modules/shaders/dist/react/Truchet.js
var Truchet_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Truchet_default
});
...
var Truchet_default = ShaderComponent;
//#endregion
export { Truchet_exports as n, Truchet_default as t };
