...
import { C as ZERO, Cn as std_exports, P as call, Pn as select, Sn as src_default, Ut as resolveBoundingBox, cr as data_exports, d as transformBoolean, hn as unpremultiplyAlpha, hr as vec2f, l as setColorSpaceMode, n as ShaderContext, s as createGpuUniformsMap, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/Flip-DYuqyJva.js
var flipUV = src_default.fn([
	vec2f,
	f32,
	f32
], vec2f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, flipX, flipY) => {
	"use gpu";
	return vec2f(select(uv.x, __tsover_sub(1, uv.x), flipX > 0), select(uv.y, __tsover_sub(1, uv.y), flipY > 0));
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, ctx, convertToTexture }) => {
		if (!childNode) {
			console.error("You must pass a child component into the Flip shader.");
			return ZERO;
		}
		const texture = convertToTexture(childNode);
		const flipped = call(flipUV, "flipUV", [
			ctx.uv,
			uniforms.flipX,
			uniforms.flipY
		]);
		return call(unpremultiplyAlpha, "unpremultiplyAlpha", [texture.sample(flipped)]);
	},
	uvRemap: ({ uv, mask, uniforms }) => {
		return {
			uv: call(flipUV, "flipUV", [
				uv,
				uniforms.flipX,
				uniforms.flipY
			]),
...
//#endregion
//#region node_modules/shaders/dist/react/Flip.js
var Flip_exports = /* @__PURE__ */ __exportAll({
...
var Flip_default = ShaderComponent;
//#endregion
export { Flip_exports as n, Flip_default as t };
