...
import { Ct as mixColorsLinear, P as call, Sn as src_default, Ut as resolveBoundingBox, an as shapeLocalCoords, c as colorSpaceOptions, f as transformColor, g as transformStrokePosition, h as transformPosition, hr as vec2f, in as sdf_exports, l as setColorSpaceMode, ln as strokeMaskFromSdf, n as ShaderContext, p as transformColorSpace, s as createGpuUniformsMap, sn as starSdf, vn as vec4, wt as mixColorsVariants, x as ShapeMask, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/Star-DRxNaHHo.js
var starShape = src_default.fn([
	vec2f,
	f32,
	f32,
	f32,
	...
	return strokeMaskFromSdf(starSdf(local.x, local.y, radius, sides, innerRatio), softness, strokeThickness, strokePosition);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: (params) => {
		...
		const mask = call(starShape, "starShape", [
			uniforms.center,
			uniforms.radius,
			uniforms.sides,
			uniforms.innerRatio,
...
//#endregion
//#region node_modules/shaders/dist/react/Star.js
...
var Star_default = ShaderComponent;
//#endregion
export { Star_exports as n, Star_default as t };
