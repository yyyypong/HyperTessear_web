...
import { Cn as std_exports, Ct as mixColorsLinear, Fn as abs, Gn as fract, P as call, Pn as select, Rn as clamp, Sn as src_default, St as mixColorStopsRuntime, Ut as resolveBoundingBox, Yn as mix, c as colorSpaceOptions, cr as data_exports, f as transformColor, h as transformPosition, hr as vec2f, l as setColorSpaceMode, n as ShaderContext, o as colorStopsPropConfig, p as transformColorSpace, qn as max, rr as sin, s as createGpuUniformsMap, wt as mixColorsVariants, yr as f32, zn as cos } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/DiamondGradient-C_2VoEiQ.js
var DEG_TO_RAD = .017453292519943295;
var diamondFinalT = src_default.fn([
	vec2f,
	f32,
	f32,
	f32,
	...
	vec2f,
	vec2f
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, size, rotation, repeat, roundness, uv, viewport) => {
	"use gpu";
	...
	const absDx = abs(rdx);
	const absDy = abs(rdy);
	const dist = mix(__tsover_add(absDx, absDy), max(absDx, absDy), roundness);
	const t = __tsover_mul(__tsover_div(dist, size), repeat);
	return select(clamp(t, 0, 1), fract(t), repeat > 1.0001);
}), {
	v: 1,
	name: void 0,
	ast: {
...
//#endregion
//#region node_modules/shaders/dist/react/DiamondGradient.js
var DiamondGradient_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => DiamondGradient_default
});
...
var DiamondGradient_default = ShaderComponent;
//#endregion
export { DiamondGradient_exports as n, DiamondGradient_default as t };
