...
import { C as ZERO, Cn as std_exports, Kn as length, P as call, Sn as src_default, Ut as resolveBoundingBox, Yn as mix, _r as vec3f, cr as data_exports, f as transformColor, h as transformPosition, hr as vec2f, ir as smoothstep, l as setColorSpaceMode, n as ShaderContext, s as createGpuUniformsMap, vr as vec4f, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/Vignette-CK_Li7v2.js
var vignetteColor = src_default.fn([
	vec4f,
	vec2f,
	f32,
	vec2f,
	...
	f32,
	f32
], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, uv, aspect, center, vigColor, radius, falloff, intensity) => {
	"use gpu";
	...
	const vignetteMask = smoothstep(radius, __tsover_add(radius, falloff), dist);
	const result = mix(vec3f(color.x, color.y, color.z), vec3f(vigColor.x, vigColor.y, vigColor.z), vec3f(__tsover_mul(vignetteMask, intensity)));
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, ctx }) => {
		...
		return call(vignetteColor, "vignetteColor", [
			childNode,
			ctx.uv,
			ctx.aspect,
			uniforms.center,
...
//#endregion
//#region node_modules/shaders/dist/react/Vignette.js
var Vignette_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Vignette_default
});
...
var Vignette_default = ShaderComponent;
//#endregion
export { Vignette_exports as n, Vignette_default as t };
