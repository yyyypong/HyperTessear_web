...
import { At as mxNoiseFloat3, Cn as std_exports, Hn as exp, Mt as noise_exports, Ot as mixStopsOrColorsExpr, P as call, Rn as clamp, Sn as src_default, Ut as resolveBoundingBox, _r as vec3f, a as animatedTime, c as colorSpaceOptions, cr as data_exports, f as transformColor, hr as vec2f, l as setColorSpaceMode, n as ShaderContext, o as colorStopsPropConfig, p as transformColorSpace, s as createGpuUniformsMap, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/SimplexNoise-C2vmRzgy.js
var simplexNoiseField = src_default.fn([
	vec2f,
	vec2f,
	f32,
	f32,
	...
	f32,
	f32
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, viewport, scale, seed, contrast, balance, animTime) => {
	"use gpu";
	const aspect = __tsover_div(viewport.x, viewport.y);
	const pos = vec2f(__tsover_mul(uv.x, aspect), uv.y).mul(exp(scale)).add(seed);
	const n = mxNoiseFloat3(vec3f(pos.x, pos.y, __tsover_mul(animTime, .5)));
	const adjusted = __tsover_add(__tsover_mul(n, __tsover_add(contrast, 1)), balance);
	const k = clamp(__tsover_add(__tsover_mul(adjusted, .5), .5), 0, 1);
...
var SimplexNoise_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => SimplexNoise_default
});
...
var SimplexNoise_default = ShaderComponent;
//#endregion
export { SimplexNoise_exports as n, SimplexNoise_default as t };
