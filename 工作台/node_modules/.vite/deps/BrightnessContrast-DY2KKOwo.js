...
import { C as ZERO, P as call, Sn as src_default, Ut as resolveBoundingBox, _r as vec3f, cr as data_exports, l as setColorSpaceMode, n as ShaderContext, s as createGpuUniformsMap, vr as vec4f, yr as f32 } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/BrightnessContrast-mbv32DkA.js
var brightnessContrastColor = src_default.fn([
	vec4f,
	f32,
	f32
], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, brightness, contrastRaw) => {
	"use gpu";
	const contrast = __tsover_add(contrastRaw, 1);
	const half = vec3f(.5, .5, .5);
	return vec4f(color.xyz.sub(half).mul(contrast).add(half).add(vec3f(brightness, brightness, brightness)), color.w);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode }) => {
		...
		return call(brightnessContrastColor, "brightnessContrastColor", [
			childNode,
			uniforms.brightness,
			uniforms.contrast
		]);
...
var BrightnessContrast_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => BrightnessContrast_default
});
...
//#endregion
export { BrightnessContrast_exports as n, BrightnessContrast_default as t };
