...
//#region node_modules/shaders/dist/core/LinearWipe-DoDZF7y0.js
var DEG_TO_RAD = Math.PI / 180;
var linearWipeMask = src_default.fn([
	vec4f,
	vec2f,
	f32,
	f32,
	...
	let t = __tsover_add(__tsover_div(grad, __tsover_mul(2, ext)), .5);
	t = select(t, __tsover_sub(1, t), invert > 0);
	const f = max(feather, 1e-4);
	const front = __tsover_sub(__tsover_mul(progress, __tsover_add(1, __tsover_mul(2, f))), f);
	const reveal = smoothstep(__tsover_sub(front, f), __tsover_add(front, f), t);
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, ctx }) => {
		if (!childNode) {
			console.error("You must pass a child component into the Linear Wipe shader.");
			return ZERO;
		}
		return call(linearWipeMask, "linearWipeMask", [
			childNode,
			ctx.uv,
			ctx.aspect,
			uniforms.angle,
...
//#endregion
//#region node_modules/shaders/dist/react/LinearWipe.js
var LinearWipe_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => LinearWipe_default
});
...
//#endregion
export { LinearWipe_exports as n, LinearWipe_default as t };
