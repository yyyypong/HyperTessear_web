...
import { C as ZERO, Cn as std_exports, Fn as abs, Gn as fract, P as call, Pn as select, Sn as src_default, Ut as resolveBoundingBox, Vn as dot, cr as data_exports, d as transformBoolean, hr as vec2f, ir as smoothstep, l as setColorSpaceMode, n as ShaderContext, qn as max, rr as sin, s as createGpuUniformsMap, vr as vec4f, yr as f32, zn as cos } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/VenetianBlinds-BZ0sS97G.js
var DEG_TO_RAD = Math.PI / 180;
var venetianBlindsMask = src_default.fn([
	vec4f,
	vec2f,
	f32,
	f32,
	...
	f32,
	f32
], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, uv, aspect, angleDeg, stripCount, progress, feather, invert) => {
	"use gpu";
	...
	const phase = fract(__tsover_mul(t, stripCount));
	const coord = select(phase, __tsover_sub(1, phase), invert > 0);
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, ctx }) => {
		if (!childNode) {
			console.error("You must pass a child component into the Venetian Blinds shader.");
			return ZERO;
		}
		return call(venetianBlindsMask, "venetianBlindsMask", [
			childNode,
			ctx.uv,
			ctx.aspect,
			uniforms.angle,
...
//#endregion
//#region node_modules/shaders/dist/react/VenetianBlinds.js
var VenetianBlinds_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => VenetianBlinds_default
});
...
//#endregion
export { VenetianBlinds_exports as n, VenetianBlinds_default as t };
