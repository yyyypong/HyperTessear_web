...
var arcShape = src_default.fn([
	...
	vec2f,
	f32
], ShapeMask)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, radius, aperture, rotation, softness, strokeThickness, strokePosition, uv, aspect) => {
	"use gpu";
	const local = shapeLocalCoords(center, rotation, uv, aspect);
	const halfAngle = __tsover_mul(aperture, APERTURE_TO_HALF_ANGLE);
	return strokeMaskFromSdf(arcSdf(local.x, local.y, radius, halfAngle), softness, strokeThickness, strokePosition);
}), {
	v: 1,
	name: void 0,
	ast: {
		...
		"externalNames": ["sdf", "APERTURE_TO_HALF_ANGLE"]
	},
	externals: () => ({
		sdf: sdf_exports,
		APERTURE_TO_HALF_ANGLE
...
var componentDefinition = {
	...
	props: {
		...
		color: {
			...
			description: "Fill color of the arc",
			ui: {
				type: "color",
				label: "Color",
				group: "Colors"
		...
		center: {
			...
			description: "Center position of the arc",
			ui: {
				type: "position",
				label: "Center",
				group: "Position",
	...
	fragment: (params) => {
		...
		const mask = call(arcShape, "arcShape", [
			uniforms.center,
			uniforms.radius,
			uniforms.aperture,
			uniforms.rotation,
...
//#endregion
//#region node_modules/shaders/dist/react/Arc.js
...
var Arc_default = ShaderComponent;
//#endregion
export { Arc_exports as n, Arc_default as t };
