...
import { Cn as std_exports, Ct as mixColorsLinear, Fn as abs, Gn as fract, P as call, Sn as src_default, Tt as mixExpr, Ut as resolveBoundingBox, a as animatedTime, c as colorSpaceOptions, f as transformColor, hr as vec2f, ir as smoothstep, kn as fwidth, l as setColorSpaceMode, n as ShaderContext, p as transformColorSpace, rr as sin, s as createGpuUniformsMap, u as transformAngle, vn as vec4, wt as mixColorsVariants, yr as f32, zn as cos } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/Chevron-CCD5JTRA.js
var DEG_TO_RAD = .0174533;
var chevronMask = src_default.fn([
	vec2f,
	vec2f,
	f32,
	f32,
	...
	f32,
	f32
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, viewport, count, angle, balance, softness, offset, animTime) => {
	"use gpu";
	...
	const zigzag = __tsover_mul(abs(__tsover_sub(fract(__tsover_mul(rotV, count)), .5)), 2);
	...
	return smoothstep(__tsover_sub(__tsover_sub(balance, softness), fw), __tsover_add(__tsover_add(balance, softness), fw), pattern);
}), {
	v: 1,
	name: void 0,
	ast: {
...
//#endregion
//#region node_modules/shaders/dist/react/Chevron.js
var Chevron_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Chevron_default
});
...
var Chevron_default = ShaderComponent;
//#endregion
export { Chevron_exports as n, Chevron_default as t };
