...
import { C as ZERO, Cn as std_exports, P as call, Sn as src_default, Ut as resolveBoundingBox, Vn as dot, _r as vec3f, cr as data_exports, l as setColorSpaceMode, n as ShaderContext, s as createGpuUniformsMap, vr as vec4f } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/Grayscale-Uv_6LYA9.js
var grayscaleColor = src_default.fn([vec4f], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color) => {
	"use gpu";
	const luminance = dot(color.xyz, vec3f(.2126, .7152, .0722));
	return vec4f(luminance, luminance, luminance, color.w);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: ({ childNode }) => {
		...
		return call(grayscaleColor, "grayscaleColor", [childNode]);
	}
};
//#endregion
//#region node_modules/shaders/dist/react/Grayscale.js
var Grayscale_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Grayscale_default
});
...
var Grayscale_default = ShaderComponent;
//#endregion
export { Grayscale_exports as n, Grayscale_default as t };
