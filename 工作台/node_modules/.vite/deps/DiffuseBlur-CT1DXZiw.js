...
import { C as ZERO, Cn as std_exports, D as applyEdgeHandlingExpr, Gn as fract, P as call, Sn as src_default, Ut as resolveBoundingBox, Vn as dot, cr as data_exports, hn as unpremultiplyAlpha, hr as vec2f, l as setColorSpaceMode, m as transformEdges, n as ShaderContext, rr as sin, s as createGpuUniformsMap, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/DiffuseBlur-Dl7S4KBW.js
var diffuseBlurUV = src_default.fn([
	vec2f,
	f32,
	vec2f
], vec2f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, intensity, viewport) => {
	"use gpu";
	const sinVal = sin(dot(uv.mul(1e3), vec2f(25.9796, 156.466)));
	const offset = fract(vec2f(__tsover_mul(sinVal, 43758.5453), __tsover_mul(sinVal, 28461.7231))).mul(2).sub(vec2f(1, 1)).mul(intensity).div(viewport);
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, ctx, propValues, convertToTexture }) => {
		...
		return call(unpremultiplyAlpha, "unpremultiplyAlpha", [applyEdgeHandlingExpr(call(diffuseBlurUV, "diffuseBlurUV", [
			ctx.uv,
			uniforms.intensity,
			ctx.viewportSize
		]), (uv) => texture.sample(uv), edgeMode)]);
	}
};
//#endregion
//#region node_modules/shaders/dist/react/DiffuseBlur.js
var DiffuseBlur_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => DiffuseBlur_default
});
...
var DiffuseBlur_default = ShaderComponent;
//#endregion
export { DiffuseBlur_exports as n, DiffuseBlur_default as t };
