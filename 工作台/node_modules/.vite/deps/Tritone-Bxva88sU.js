...
import { C as ZERO, Cn as std_exports, Ct as mixColorsLinear, P as call, Sn as src_default, Ut as resolveBoundingBox, Vn as dot, _r as vec3f, c as colorSpaceOptions, cr as data_exports, f as transformColor, ir as smoothstep, l as setColorSpaceMode, n as ShaderContext, p as transformColorSpace, s as createGpuUniformsMap, vn as vec4, vr as vec4f, wt as mixColorsVariants, yr as f32 } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/Tritone-Ta084wlF.js
var tritoneFactors = src_default.fn([vec4f, f32], vec3f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, blendMid) => {
	"use gpu";
	const luminance = dot(color.xyz, vec3f(.299, .587, .114));
	return vec3f(smoothstep(__tsover_sub(blendMid, .25), blendMid, luminance), smoothstep(blendMid, __tsover_add(blendMid, .25), luminance), smoothstep(__tsover_sub(blendMid, .1), __tsover_add(blendMid, .1), luminance));
}), {
	v: 1,
	name: void 0,
	ast: {
...
var Tritone_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Tritone_default
});
...
var Tritone_default = ShaderComponent;
//#endregion
export { Tritone_exports as n, Tritone_default as t };
