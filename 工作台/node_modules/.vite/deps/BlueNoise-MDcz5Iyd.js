...
import { Cn as std_exports, Mt as noise_exports, N as blue12, P as call, Sn as src_default, Ut as resolveBoundingBox, Wn as floor, fn as toneAndColorExpr, hr as vec2f, l as setColorSpaceMode, n as ShaderContext, s as createGpuUniformsMap, yr as f32 } from "./Shader-BPX4e-H3.js";
...
//#region node_modules/shaders/dist/core/BlueNoise-BqMtBLxM.js
var blueNoiseField = src_default.fn([
	vec2f,
	vec2f,
	f32,
	f32
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, viewport, grain, seed) => {
	"use gpu";
	return blue12(floor(uv.mul(viewport).div(grain)).add(seed));
}), {
	v: 1,
	name: void 0,
	ast: {
...
//#endregion
//#region node_modules/shaders/dist/react/BlueNoise.js
var BlueNoise_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => BlueNoise_default
});
...
var BlueNoise_default = ShaderComponent;
//#endregion
export { BlueNoise_exports as n, BlueNoise_default as t };
