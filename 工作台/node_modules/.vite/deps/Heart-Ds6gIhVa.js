...
var heartShape = src_default.fn([
	...
	vec2f,
	f32
], ShapeMask)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, radius, rotation, softness, strokeThickness, strokePosition, uv, aspect) => {
	"use gpu";
	const local = shapeLocalCoords(center, rotation, uv, aspect);
	return strokeMaskFromSdf(heartSdf(local.x, local.y, radius), softness, strokeThickness, strokePosition);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	props: {
		...
		color: {
			...
			description: "Fill color of the heart",
			ui: {
				type: "color",
				label: "Color",
				group: "Colors"
		...
		center: {
			...
			description: "Center position of the heart",
			ui: {
				type: "position",
				label: "Center",
				group: "Position",
	...
	fragment: (params) => {
		...
		const mask = call(heartShape, "heartShape", [
			uniforms.center,
			uniforms.radius,
			uniforms.rotation,
			uniforms.softness,
...
//#endregion
//#region node_modules/shaders/dist/react/Heart.js
var Heart_exports = /* @__PURE__ */ __exportAll({
...
var Heart_default = ShaderComponent;
//#endregion
export { Heart_exports as n, Heart_default as t };
