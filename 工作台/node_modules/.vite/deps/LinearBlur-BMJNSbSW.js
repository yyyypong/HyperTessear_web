...
import { C as ZERO, Cn as std_exports, P as call, Sn as src_default, Ut as resolveBoundingBox, cr as data_exports, hn as unpremultiplyAlpha, hr as vec2f, it as floatE, l as setColorSpaceMode, n as ShaderContext, rr as sin, s as createGpuUniformsMap, u as transformAngle, yr as f32, zn as cos } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/LinearBlur-CV7gKYHV.js
...
var linearBlurTapCoord = src_default.fn([
	vec2f,
	f32,
	f32,
	vec2f,
	f32
], vec2f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, angleDeg, intensity, viewport, tapT) => {
	"use gpu";
	const angleRad = __tsover_mul(angleDeg, DEG_TO_RAD);
	const aspect = __tsover_div(viewport.x, viewport.y);
	const dirX = __tsover_div(cos(angleRad), aspect);
	...
	return vec2f(__tsover_add(uv.x, __tsover_mul(bvX, tapT)), __tsover_add(uv.y, __tsover_mul(bvY, tapT)));
}), {
	v: 1,
	name: void 0,
	ast: {
...
var LinearBlur_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => LinearBlur_default
});
...
var LinearBlur_default = ShaderComponent;
//#endregion
export { LinearBlur_exports as n, LinearBlur_default as t };
