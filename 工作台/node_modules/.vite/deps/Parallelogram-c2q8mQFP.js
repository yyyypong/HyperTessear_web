...
import { Ct as mixColorsLinear, Lt as parallelogramSdf, P as call, Sn as src_default, Ut as resolveBoundingBox, an as shapeLocalCoords, c as colorSpaceOptions, f as transformColor, g as transformStrokePosition, h as transformPosition, hr as vec2f, in as sdf_exports, l as setColorSpaceMode, ln as strokeMaskFromSdf, n as ShaderContext, p as transformColorSpace, s as createGpuUniformsMap, vn as vec4, wt as mixColorsVariants, x as ShapeMask, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/Parallelogram-DBi0yAG3.js
var parallelogramShape = src_default.fn([
	vec2f,
	f32,
	f32,
	f32,
	...
	vec2f,
	f32
], ShapeMask)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, width, height, skew, rotation, softness, strokeThickness, strokePosition, uv, aspect) => {
	"use gpu";
	const local = shapeLocalCoords(center, rotation, uv, aspect);
	return strokeMaskFromSdf(parallelogramSdf(local.x, local.y, width, height, skew), softness, strokeThickness, strokePosition);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	props: {
		...
		color: {
			...
			description: "Fill color of the parallelogram",
			ui: {
				type: "color",
				label: "Color",
				group: "Colors"
		...
		center: {
			...
			description: "Center position of the parallelogram",
			ui: {
				type: "position",
				label: "Center",
				group: "Position",
	...
	fragment: (params) => {
		...
		const mask = call(parallelogramShape, "parallelogramShape", [
			uniforms.center,
			uniforms.width,
			uniforms.height,
			uniforms.skew,
...
//#endregion
//#region node_modules/shaders/dist/react/Parallelogram.js
var Parallelogram_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Parallelogram_default
});
...
var Parallelogram_default = ShaderComponent;
//#endregion
export { Parallelogram_exports as n, Parallelogram_default as t };
