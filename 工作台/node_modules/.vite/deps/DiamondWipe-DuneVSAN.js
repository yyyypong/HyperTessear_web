...
import { C as ZERO, Cn as std_exports, Fn as abs, Gn as fract, P as call, Pn as select, Sn as src_default, Ut as resolveBoundingBox, cr as data_exports, d as transformBoolean, hr as vec2f, ir as smoothstep, l as setColorSpaceMode, n as ShaderContext, qn as max, s as createGpuUniformsMap, vr as vec4f, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/DiamondWipe-BkdNODD1.js
var diamondWipeMask = src_default.fn([
	vec4f,
	vec2f,
	f32,
	f32,
	...
	f32,
	f32
], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, uv, aspect, size, feather, progress, invert) => {
	"use gpu";
	const gridX = __tsover_div(1, max(size, .001));
	const gridY = max(__tsover_div(gridX, aspect), 1);
	const lx = __tsover_sub(fract(__tsover_mul(uv.x, gridX)), .5);
	const ly = __tsover_sub(fract(__tsover_mul(uv.y, gridY)), .5);
	let coord = __tsover_add(abs(lx), abs(ly));
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, ctx }) => {
		if (!childNode) {
			console.error("You must pass a child component into the Diamond Wipe shader.");
			return ZERO;
		}
		return call(diamondWipeMask, "diamondWipeMask", [
			childNode,
			ctx.uv,
			ctx.aspect,
			uniforms.size,
...
//#endregion
//#region node_modules/shaders/dist/react/DiamondWipe.js
var DiamondWipe_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => DiamondWipe_default
});
...
//#endregion
export { DiamondWipe_exports as n, DiamondWipe_default as t };
