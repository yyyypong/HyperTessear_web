...
//#region node_modules/shaders/dist/core/Duotone-x4cywJbU.js
var duotoneFactor = src_default.fn([vec4f, f32], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, blend) => {
	"use gpu";
	const luminance = dot(color.xyz, vec3f(.299, .587, .114));
	return smoothstep(__tsover_sub(blend, .5), __tsover_add(blend, .5), luminance);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, propValues }) => {
		...
		const t = call(duotoneFactor, "duotoneFactor", [childNode, uniforms.blend]);
...
var Duotone_exports = /* @__PURE__ */ __exportAll({
...
var Duotone_default = ShaderComponent;
//#endregion
export { Duotone_exports as n, Duotone_default as t };
