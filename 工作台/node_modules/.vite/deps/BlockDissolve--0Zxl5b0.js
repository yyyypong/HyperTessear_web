...
var blockDissolveMask = src_default.fn([
	...
	let r = hash12(vec2f(floor(__tsover_mul(uv.x, gridX)), floor(__tsover_mul(uv.y, gridY))));
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, ctx }) => {
		if (!childNode) {
			console.error("You must pass a child component into the Block Dissolve shader.");
			return ZERO;
		}
		return call(blockDissolveMask, "blockDissolveMask", [
			childNode,
			ctx.uv,
			ctx.aspect,
			uniforms.blockSize,
...
//#endregion
//#region node_modules/shaders/dist/react/BlockDissolve.js
var BlockDissolve_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => BlockDissolve_default
});
...
//#endregion
export { BlockDissolve_exports as n, BlockDissolve_default as t };
