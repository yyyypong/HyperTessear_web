...
import { Cn as std_exports, Ct as mixColorsLinear, Dn as dpdx, Fn as abs, Gn as fract, On as dpdy, P as call, Rn as clamp, Sn as src_default, Ut as resolveBoundingBox, Wn as floor, a as animatedTime, c as colorSpaceOptions, f as transformColor, hr as vec2f, l as setColorSpaceMode, n as ShaderContext, p as transformColorSpace, qn as max, rr as sin, s as createGpuUniformsMap, u as transformAngle, wt as mixColorsVariants, yr as f32, zn as cos } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/Stripes-BvnoWdwn.js
var DEG_TO_RAD = .0174533;
var stripeCoordP = src_default.fn([
	vec2f,
	vec2f,
	f32,
	f32,
	f32,
	f32
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, viewport, angle, density, animTime, offset) => {
	"use gpu";
	const aspect = __tsover_div(viewport.x, max(viewport.y, 1e-6));
...
var stripeMaskValue = src_default.fn([
	f32,
	f32,
	f32
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((p, w, balance) => {
	"use gpu";
	...
	const Fa = __tsover_add(__tsover_mul(floor(a), oneMinusBalance), max(__tsover_sub(fract(a), balance), 0));
	const Fb = __tsover_add(__tsover_mul(floor(b), oneMinusBalance), max(__tsover_sub(fract(b), balance), 0));
	return clamp(__tsover_div(__tsover_sub(Fa, Fb), w), 0, 1);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var stripesMask = src_default.fn([
	vec2f,
	vec2f,
	f32,
	f32,
	...
	f32,
	f32
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, viewport, angle, density, animTime, offset, balance, softness) => {
	"use gpu";
	const p = stripeCoordP(uv, viewport, angle, density, animTime, offset);
	const dpx = dpdx(p);
	const dpy = dpdy(p);
	const baseW = max(abs(dpx), abs(dpy));
	return stripeMaskValue(p, max(__tsover_add(baseW, softness), 1e-5), balance);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var Stripes_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Stripes_default
});
...
var Stripes_default = ShaderComponent;
//#endregion
export { Stripes_exports as n, Stripes_default as t };
