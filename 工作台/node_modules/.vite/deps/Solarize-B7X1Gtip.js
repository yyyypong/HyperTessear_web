...
import { C as ZERO, Cn as std_exports, P as call, Pn as select, Sn as src_default, Ut as resolveBoundingBox, Vn as dot, Yn as mix, _r as vec3f, cr as data_exports, l as setColorSpaceMode, n as ShaderContext, s as createGpuUniformsMap, vr as vec4f, yr as f32 } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/Solarize-205KKROH.js
var solarizeColor = src_default.fn([
	vec4f,
	f32,
	f32
], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, threshold, strength) => {
	"use gpu";
	const rgb = vec3f(color.x, color.y, color.z);
	const luminance = dot(rgb, vec3f(.299, .587, .114));
	const result = mix(rgb, select(rgb, vec3f(__tsover_sub(1, color.x), __tsover_sub(1, color.y), __tsover_sub(1, color.z)), luminance > threshold), vec3f(strength));
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode }) => {
		...
		return call(solarizeColor, "solarizeColor", [
			childNode,
			uniforms.threshold,
			uniforms.strength
		]);
...
//#endregion
//#region node_modules/shaders/dist/react/Solarize.js
var Solarize_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Solarize_default
});
...
var Solarize_default = ShaderComponent;
//#endregion
export { Solarize_exports as n, Solarize_default as t };
