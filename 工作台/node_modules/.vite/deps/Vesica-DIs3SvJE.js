...
import { Ct as mixColorsLinear, P as call, Sn as src_default, Ut as resolveBoundingBox, an as shapeLocalCoords, c as colorSpaceOptions, f as transformColor, g as transformStrokePosition, h as transformPosition, hr as vec2f, in as sdf_exports, l as setColorSpaceMode, ln as strokeMaskFromSdf, n as ShaderContext, p as transformColorSpace, s as createGpuUniformsMap, vn as vec4, wt as mixColorsVariants, x as ShapeMask, yn as vesicaSdf, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/Vesica-Cf1KiSzK.js
var vesicaShape = src_default.fn([
	vec2f,
	f32,
	f32,
	f32,
	...
	vec2f,
	f32
], ShapeMask)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, radius, spread, rotation, softness, strokeThickness, strokePosition, uv, aspect) => {
	"use gpu";
	const local = shapeLocalCoords(center, rotation, uv, aspect);
	return strokeMaskFromSdf(vesicaSdf(local.x, local.y, radius, spread), softness, strokeThickness, strokePosition);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: (params) => {
		...
		const mask = call(vesicaShape, "vesicaShape", [
			uniforms.center,
			uniforms.radius,
			uniforms.spread,
			uniforms.rotation,
...
//#endregion
//#region node_modules/shaders/dist/react/Vesica.js
var Vesica_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Vesica_default
});
...
var Vesica_default = ShaderComponent;
//#endregion
export { Vesica_exports as n, Vesica_default as t };
