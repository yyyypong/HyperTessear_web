...
import { C as ZERO, Cn as std_exports, Gn as fract, P as call, Rn as clamp, Sn as src_default, Ut as resolveBoundingBox, Vn as dot, Zn as pow, _r as vec3f, cr as data_exports, hr as vec2f, l as setColorSpaceMode, n as ShaderContext, rr as sin, s as createGpuUniformsMap, vr as vec4f, yr as f32 } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/FilmGrain-DDhrsw94.js
var filmGrainColor = src_default.fn([
	vec4f,
	vec2f,
	vec2f,
	f32,
	f32,
	f32
], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, uv, viewport, strength, bias, animTime) => {
	"use gpu";
	const pixelCoord = uv.mul(viewport);
	const noiseInput = __tsover_add(dot(pixelCoord, vec2f(12.9898, 78.233)), animTime);
	const noise = fract(__tsover_mul(sin(noiseInput), 43758.5453));
	const grain = __tsover_sub(__tsover_mul(noise, 2), 1);
	const brightness = clamp(dot(color.xyz, vec3f(.2126, .7152, .0722)), 0, 1);
	const darkness = __tsover_sub(1, brightness);
	const darkFactor = pow(__tsover_add(darkness, 1e-6), bias);
	const grainIntensity = __tsover_mul(__tsover_mul(grain, darkFactor), __tsover_mul(strength, .1));
	return vec4f(color.xyz.add(grainIntensity), color.w);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var FilmGrain_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => FilmGrain_default
});
...
var FilmGrain_default = ShaderComponent;
//#endregion
export { FilmGrain_exports as n, FilmGrain_default as t };
