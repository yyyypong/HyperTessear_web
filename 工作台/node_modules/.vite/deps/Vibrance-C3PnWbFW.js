...
import { C as ZERO, Cn as std_exports, P as call, Sn as src_default, Ut as resolveBoundingBox, Yn as mix, _r as vec3f, cr as data_exports, l as setColorSpaceMode, n as ShaderContext, qn as max, s as createGpuUniformsMap, vr as vec4f, yr as f32 } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/Vibrance-qWGvLkrW.js
var vibranceColor = src_default.fn([vec4f, f32], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, adjustment) => {
	"use gpu";
	const r = color.x;
	const g = color.y;
	const b = color.z;
	const average = __tsover_div(__tsover_add(__tsover_add(r, g), b), 3);
	const mx = max(r, max(g, b));
	const amt = __tsover_mul(__tsover_mul(__tsover_sub(mx, average), adjustment), -3);
	const vibrant = mix(vec3f(r, g, b), vec3f(mx, mx, mx), vec3f(amt));
	return vec4f(vibrant.x, vibrant.y, vibrant.z, color.w);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode }) => {
		...
		return call(vibranceColor, "vibranceColor", [childNode, uniforms.intensity]);
	}
};
//#endregion
//#region node_modules/shaders/dist/react/Vibrance.js
var Vibrance_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Vibrance_default
});
...
var Vibrance_default = ShaderComponent;
//#endregion
export { Vibrance_exports as n, Vibrance_default as t };
