...
import { Cn as std_exports, Ct as mixColorsLinear, Gn as fract, Ln as atan2, P as call, Sn as src_default, St as mixColorStopsRuntime, Ut as resolveBoundingBox, c as colorSpaceOptions, cr as data_exports, f as transformColor, h as transformPosition, hr as vec2f, l as setColorSpaceMode, n as ShaderContext, o as colorStopsPropConfig, p as transformColorSpace, qn as max, s as createGpuUniformsMap, wt as mixColorsVariants, yr as f32 } from "./Shader-BPX4e-H3.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_react_dom } from "./react-dom.js";
//#region node_modules/shaders/dist/core/ConicGradient-Cg6vy3gl.js
var TAU = 6.283185307179586;
var INV_360 = 1 / 360;
var conicFinalT = src_default.fn([
	vec2f,
	f32,
	f32,
	vec2f,
	vec2f
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, rotation, repeat, uv, viewport) => {
	"use gpu";
	...
	const angle = atan2(__tsover_sub(aspectUV.y, centerPos.y), dx);
	const normalized = __tsover_sub(.5, __tsover_div(angle, TAU));
	const rotationFraction = __tsover_mul(rotation, INV_360);
	return fract(__tsover_mul(__tsover_add(normalized, rotationFraction), repeat));
}), {
	v: 1,
	name: void 0,
	ast: {
...
//#endregion
//#region node_modules/shaders/dist/react/ConicGradient.js
var ConicGradient_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => ConicGradient_default
});
...
var ConicGradient_default = ShaderComponent;
//#endregion
export { ConicGradient_exports as n, ConicGradient_default as t };
