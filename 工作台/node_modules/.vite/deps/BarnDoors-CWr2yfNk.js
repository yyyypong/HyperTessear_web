...
//#region node_modules/shaders/dist/core/BarnDoors-B_kxVuec.js
var DEG_TO_RAD = Math.PI / 180;
var barnDoorsMask = src_default.fn([
	vec4f,
	vec2f,
	f32,
	f32,
	...
	f32,
	f32
], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, uv, aspect, angleDeg, progress, feather, invert) => {
	"use gpu";
	...
	let coord = __tsover_mul(abs(__tsover_sub(t, .5)), 2);
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, ctx }) => {
		if (!childNode) {
			console.error("You must pass a child component into the Barn Doors shader.");
			return ZERO;
		}
		return call(barnDoorsMask, "barnDoorsMask", [
			childNode,
			ctx.uv,
			ctx.aspect,
			uniforms.angle,
...
//#endregion
//#region node_modules/shaders/dist/react/BarnDoors.js
var BarnDoors_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => BarnDoors_default
});
...
//#endregion
export { BarnDoors_exports as n, BarnDoors_default as t };
