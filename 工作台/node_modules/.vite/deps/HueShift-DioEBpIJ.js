...
import { C as ZERO, Cn as std_exports, P as call, Sn as src_default, Ut as resolveBoundingBox, cr as data_exports, l as setColorSpaceMode, n as ShaderContext, rr as sin, s as createGpuUniformsMap, vr as vec4f, yr as f32, zn as cos } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/HueShift-BCDgYfJs.js
var DEG_TO_RAD = Math.PI / 180;
var SQRT3 = 1.7320508075688772;
var hueShiftColor = src_default.fn([vec4f, f32], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, shiftDeg) => {
	"use gpu";
	const angle = __tsover_mul(shiftDeg, DEG_TO_RAD);
	const cosA = cos(angle);
	const sinA = sin(angle);
	const k = __tsover_div(1, 3);
	const oneMinusCos = __tsover_sub(1, cosA);
	const kOneMinusCos = __tsover_mul(oneMinusCos, k);
	const sinOverSqrt3 = __tsover_div(sinA, SQRT3);
	const m00 = __tsover_add(cosA, kOneMinusCos);
	const m01 = __tsover_sub(kOneMinusCos, sinOverSqrt3);
	const m02 = __tsover_add(kOneMinusCos, sinOverSqrt3);
	const m10 = __tsover_add(kOneMinusCos, sinOverSqrt3);
	const m11 = __tsover_add(cosA, kOneMinusCos);
	const m12 = __tsover_sub(kOneMinusCos, sinOverSqrt3);
	const m20 = __tsover_sub(kOneMinusCos, sinOverSqrt3);
	const m21 = __tsover_add(kOneMinusCos, sinOverSqrt3);
	const m22 = __tsover_add(cosA, kOneMinusCos);
	const r = color.x;
	const g = color.y;
	const b = color.z;
	return vec4f(__tsover_add(__tsover_add(__tsover_mul(r, m00), __tsover_mul(g, m01)), __tsover_mul(b, m02)), __tsover_add(__tsover_add(__tsover_mul(r, m10), __tsover_mul(g, m11)), __tsover_mul(b, m12)), __tsover_add(__tsover_add(__tsover_mul(r, m20), __tsover_mul(g, m21)), __tsover_mul(b, m22)), color.w);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, propValues }) => {
		...
		if ((propValues.shift ?? 0) === 0) return childNode;
		return call(hueShiftColor, "hueShiftColor", [childNode, uniforms.shift]);
	}
};
//#endregion
//#region node_modules/shaders/dist/react/HueShift.js
var HueShift_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => HueShift_default
});
...
var HueShift_default = ShaderComponent;
//#endregion
export { HueShift_exports as n, HueShift_default as t };
