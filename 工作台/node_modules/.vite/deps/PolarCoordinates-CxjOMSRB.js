...
import { C as ZERO, Cn as std_exports, Kn as length, Ln as atan2, P as call, R as composeEdgeRemapExpr, Sn as src_default, Tt as mixExpr, Ut as resolveBoundingBox, Yt as sampleRemappedExpr, cr as data_exports, h as transformPosition, hn as unpremultiplyAlpha, hr as vec2f, l as setColorSpaceMode, m as transformEdges, n as ShaderContext, s as createGpuUniformsMap, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/PolarCoordinates-B8Cq2bzT.js
var PI = Math.PI;
var TAU = Math.PI * 2;
var polarCoordsUV = src_default.fn([
	vec2f,
	f32,
	f32,
	vec2f,
	f32
], vec2f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, wrap, radius, uv, aspect) => {
	"use gpu";
	...
	const theta = atan2(delta.y, delta.x);
	const normalizedAngle = __tsover_div(__tsover_add(theta, PI), TAU);
	const r = length(delta);
	return vec2f(__tsover_mul(normalizedAngle, wrap), __tsover_mul(r, radius));
}), {
	v: 1,
	name: void 0,
	ast: {
...
var PolarCoordinates_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => PolarCoordinates_default
});
...
//#endregion
export { PolarCoordinates_exports as n, PolarCoordinates_default as t };
