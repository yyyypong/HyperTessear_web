...
import { C as ZERO, Cn as std_exports, P as call, Sn as src_default, Ut as resolveBoundingBox, Vn as dot, Yn as mix, _r as vec3f, cr as data_exports, l as setColorSpaceMode, n as ShaderContext, s as createGpuUniformsMap, vr as vec4f, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/Saturation-Dqifs1x7.js
var saturationColor = src_default.fn([vec4f, f32], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, intensity) => {
	"use gpu";
	const rgb = vec3f(color.x, color.y, color.z);
	const luminance = dot(rgb, vec3f(.2126, .7152, .0722));
	const saturated = mix(vec3f(luminance, luminance, luminance), rgb, vec3f(intensity));
	return vec4f(saturated.x, saturated.y, saturated.z, color.w);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, propValues }) => {
		...
		if ((propValues.intensity ?? 1) === 1) return childNode;
		return call(saturationColor, "saturationColor", [childNode, uniforms.intensity]);
	}
};
//#endregion
//#region node_modules/shaders/dist/react/Saturation.js
var Saturation_exports = /* @__PURE__ */ __exportAll({
...
//#endregion
export { Saturation_exports as n, Saturation_default as t };
