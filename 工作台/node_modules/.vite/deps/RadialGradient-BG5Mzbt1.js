...
//#region node_modules/shaders/dist/core/RadialGradient-j6T56q1W.js
var DEG_TO_RAD = .017453292519943295;
var radialFinalT = src_default.fn([
	vec2f,
	f32,
	f32,
	f32,
	...
	vec2f,
	vec2f
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, skewAngle, ellipseAspect, radius, repeat, uv, viewport) => {
	"use gpu";
	const safeViewportY = max(viewport.y, 1e-6);
	const aspectRatio = __tsover_div(viewport.x, safeViewportY);
	const acUV = vec2f(__tsover_mul(uv.x, aspectRatio), uv.y);
	const centerPos = vec2f(__tsover_mul(center.x, aspectRatio), __tsover_sub(1, center.y));
	...
	const dist = length(vec2f(__tsover_mul(rdx, ellipseAspect), rdy));
	const safeRadius = max(radius, 1e-6);
...
var RadialGradient_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => RadialGradient_default
});
...
//#endregion
export { RadialGradient_exports as n, RadialGradient_default as t };
