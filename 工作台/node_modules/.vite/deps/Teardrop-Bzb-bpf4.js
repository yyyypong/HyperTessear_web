...
import { Ct as mixColorsLinear, P as call, Sn as src_default, Ut as resolveBoundingBox, an as shapeLocalCoords, c as colorSpaceOptions, f as transformColor, g as transformStrokePosition, h as transformPosition, hr as vec2f, in as sdf_exports, l as setColorSpaceMode, ln as strokeMaskFromSdf, n as ShaderContext, p as transformColorSpace, s as createGpuUniformsMap, un as teardropSdf, vn as vec4, wt as mixColorsVariants, x as ShapeMask, yr as f32 } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/Teardrop-Bjtkigk4.js
var teardropShape = src_default.fn([
	vec2f,
	f32,
	f32,
	f32,
	...
	vec2f,
	f32
], ShapeMask)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((center, radius, height, rotation, softness, strokeThickness, strokePosition, uv, aspect) => {
	"use gpu";
	const local = shapeLocalCoords(center, rotation, uv, aspect);
	return strokeMaskFromSdf(teardropSdf(local.x, local.y, radius, height), softness, strokeThickness, strokePosition);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var componentDefinition = {
	...
	props: {
		...
		color: {
			...
			description: "Fill color of the teardrop",
			ui: {
				type: "color",
				label: "Color",
				group: "Colors"
		...
		center: {
			...
			description: "Center position of the teardrop",
			ui: {
				type: "position",
				label: "Center",
				group: "Position",
	...
	fragment: (params) => {
		...
		const mask = call(teardropShape, "teardropShape", [
			uniforms.center,
			uniforms.radius,
			uniforms.height,
			uniforms.rotation,
...
//#endregion
//#region node_modules/shaders/dist/react/Teardrop.js
var Teardrop_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => Teardrop_default
});
...
var Teardrop_default = ShaderComponent;
//#endregion
export { Teardrop_exports as n, Teardrop_default as t };
