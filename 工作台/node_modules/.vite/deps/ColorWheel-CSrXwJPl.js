...
import { Cn as std_exports, Ct as mixColorsLinear, Fn as abs, Gn as fract, P as call, Rn as clamp, Sn as src_default, Ut as resolveBoundingBox, Wn as floor, Yn as mix, a as animatedTime, c as colorSpaceOptions, cr as data_exports, f as transformColor, hr as vec2f, l as setColorSpaceMode, n as ShaderContext, or as step, p as transformColorSpace, rr as sin, s as createGpuUniformsMap, u as transformAngle, vr as vec4f, wt as mixColorsVariants, yr as f32, zn as cos } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/ColorWheel-CXvfWAjN.js
var DEG_TO_RAD = .0174533;
var colorWheelT = src_default.fn([
	vec2f,
	vec2f,
	f32,
	f32,
	f32
], f32)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((uv, viewport, angle, scale, animTime) => {
	"use gpu";
	...
	return fract(__tsover_add(__tsover_mul(__tsover_mul(projectedCoord, scale), .2), animTime));
}), {
	v: 1,
	name: void 0,
	ast: {
...
var colorWheelRainbow = src_default.fn([f32], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((t) => {
	"use gpu";
	const h6 = __tsover_mul(t, 6);
	return vec4f(clamp(__tsover_sub(abs(__tsover_sub(h6, 3)), 1), 0, 1), clamp(__tsover_sub(2, abs(__tsover_sub(h6, 2))), 0, 1), clamp(__tsover_sub(2, abs(__tsover_sub(h6, 4))), 0, 1), 1);
}), {
	v: 1,
	name: void 0,
	ast: {
...
var colorWheelPhase = src_default.fn([f32], vec2f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((t) => {
	"use gpu";
...
var colorWheelSelect = src_default.fn([
	vec4f,
	vec4f,
	vec4f,
	f32
], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((c01, c12, c20, floorT3) => {
	"use gpu";
	return mix(mix(c20, c12, step(floorT3, 1.5)), c01, step(floorT3, .5));
}), {
	v: 1,
	name: void 0,
	ast: {
...
//#endregion
//#region node_modules/shaders/dist/react/ColorWheel.js
var ColorWheel_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => ColorWheel_default
});
...
var ColorWheel_default = ShaderComponent;
//#endregion
export { ColorWheel_exports as n, ColorWheel_default as t };
