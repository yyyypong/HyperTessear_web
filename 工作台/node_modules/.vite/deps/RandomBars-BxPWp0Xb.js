...
import { C as ZERO, Cn as std_exports, Fn as abs, Mt as noise_exports, P as call, Pn as select, Sn as src_default, Ut as resolveBoundingBox, Vn as dot, Wn as floor, cr as data_exports, d as transformBoolean, hr as vec2f, ir as smoothstep, l as setColorSpaceMode, n as ShaderContext, qn as max, rr as sin, s as createGpuUniformsMap, ut as hash11, vr as vec4f, yr as f32, zn as cos } from "./Shader-BPX4e-H3.js";
//#region node_modules/shaders/dist/core/RandomBars-3RlhwDYG.js
var DEG_TO_RAD = Math.PI / 180;
var randomBarsMask = src_default.fn([
	vec4f,
	vec2f,
	f32,
	f32,
	...
	f32,
	f32
], vec4f)(/* @__PURE__ */ (($) => (globalThis.__TYPEGPU_META__ ??= /* @__PURE__ */ new WeakMap()).set($.f = ((color, uv, aspect, angleDeg, barCount, softness, progress, invert) => {
	"use gpu";
	const a = __tsover_mul(angleDeg, DEG_TO_RAD);
	const dir = vec2f(cos(a), sin(a));
	const grad = dot(vec2f(__tsover_mul(__tsover_sub(uv.x, .5), aspect), __tsover_sub(uv.y, .5)), dir);
	...
	const idx = floor(__tsover_mul(t, max(barCount, 1)));
	let r = hash11(__tsover_add(idx, .5));
...
var componentDefinition = {
	...
	fragment: ({ uniforms, childNode, ctx }) => {
		if (!childNode) {
			console.error("You must pass a child component into the Random Bars shader.");
			return ZERO;
		}
		return call(randomBarsMask, "randomBarsMask", [
			childNode,
			ctx.uv,
			ctx.aspect,
			uniforms.angle,
...
//#endregion
//#region node_modules/shaders/dist/react/RandomBars.js
var RandomBars_exports = /* @__PURE__ */ __exportAll({
	ShaderComponent: () => ShaderComponent,
	default: () => RandomBars_default
});
...
//#endregion
export { RandomBars_exports as n, RandomBars_default as t };
