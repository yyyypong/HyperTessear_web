...
export interface ComponentProps {
    ...
    /**
     * Circumradius — distance from center to vertices in UV space
     *
    ...
    sides: number;
    /**
     * Corner rounding — 0 is sharp vertices, 1 morphs into a circle
     *
     * Accepts a number between 0 and 1.
     * @default 0
     */
...
export declare const polygonShape: import('typegpu').TgpuFn<(center: d.Vec2f, radius: d.F32, sides: d.F32, rounding: d.F32, rotation: d.F32, softness: d.F32, strokeThickness: d.F32, strokePosition: d.F32, uv: d.Vec2f, aspect: d.F32) => d.WgslStruct<{
    overallMask: d.F32;
    strokeBlend: d.F32;
}>>;
