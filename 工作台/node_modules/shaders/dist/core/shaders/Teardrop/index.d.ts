...
export interface ComponentProps {
     ...
     *
     * Accepts a number between 0.02 and 0.6.
     * @default 0.22
     */
     ...
     *
     * Accepts a number between 0.1 and 0.7.
     * @default 0.4
     */
...
export declare const teardropShape: import('typegpu').TgpuFn<(center: d.Vec2f, radius: d.F32, height: d.F32, rotation: d.F32, softness: d.F32, strokeThickness: d.F32, strokePosition: d.F32, uv: d.Vec2f, aspect: d.F32) => d.WgslStruct<{
    overallMask: d.F32;
    strokeBlend: d.F32;
}>>;
