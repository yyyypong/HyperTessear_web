...
export declare const heartShape: import('typegpu').TgpuFn<(center: d.Vec2f, radius: d.F32, rotation: d.F32, softness: d.F32, strokeThickness: d.F32, strokePosition: d.F32, uv: d.Vec2f, aspect: d.F32) => d.WgslStruct<{
    overallMask: d.F32;
    strokeBlend: d.F32;
}>>;
