...
export interface ComponentProps {
    ...
    /**
     * Outer tip radius — distance from center to the pointed tips
     *
     ...
     *
     * Accepts a number between 3 and 12.
     * @default 5
     */
    sides: number;
    /**
     * Inner vertex radius as a ratio of outer radius (0.382 = golden-ratio 5-star)
     *
     * Accepts a number between 0.1 and 0.9.
     * @default 0.4
     */
    innerRatio: number;
    /**
...
export declare const starShape: import('typegpu').TgpuFn<(center: d.Vec2f, radius: d.F32, sides: d.F32, innerRatio: d.F32, rotation: d.F32, softness: d.F32, strokeThickness: d.F32, strokePosition: d.F32, uv: d.Vec2f, aspect: d.F32) => d.WgslStruct<{
    overallMask: d.F32;
    strokeBlend: d.F32;
}>>;
