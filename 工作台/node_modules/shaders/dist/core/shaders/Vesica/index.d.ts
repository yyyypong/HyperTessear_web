...
import { BoundingBoxOrigin, DimensionalValue } from '../../types';
...
export interface ComponentProps {
    ...
    /**
     * Radius of the two overlapping circles
     *
     * Accepts a number between 0.05 and 1.
     * @default 0.35
     */
    radius: number | DimensionalValue;
    /**
     * Circle separation — 0 = full circle overlap, 1 = infinitely thin lens
     *
     * Accepts a number between 0.05 and 0.95.
     * @default 0.5
     */
    spread: number;
    /**
     ...
     *
     * Accepts a number between 0 and 0.1.
     * @default 0
     */
    softness: number;
    /**
     ...
     *
     * Accepts a number between 0 and 0.2.
     * @default 0
     */
...
export declare const vesicaShape: import('typegpu').TgpuFn<(center: d.Vec2f, radius: d.F32, spread: d.F32, rotation: d.F32, softness: d.F32, strokeThickness: d.F32, strokePosition: d.F32, uv: d.Vec2f, aspect: d.F32) => d.WgslStruct<{
    overallMask: d.F32;
    strokeBlend: d.F32;
}>>;
