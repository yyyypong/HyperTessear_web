...
import { ComponentProps } from '../../core/shaders/Heatmap';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'center' | 'innerGlow' | 'outerGlow' | 'contour'>> & {
