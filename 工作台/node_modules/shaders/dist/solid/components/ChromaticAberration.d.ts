...
import { ComponentProps } from '../../core/shaders/ChromaticAberration';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'strength' | 'angle' | 'redOffset' | 'greenOffset' | 'blueOffset'>> & {
