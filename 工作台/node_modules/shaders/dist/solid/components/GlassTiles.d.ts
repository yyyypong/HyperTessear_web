...
import { ComponentProps } from '../../core/shaders/GlassTiles';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'intensity' | 'tileCount' | 'rotation' | 'roundness'>> & {
