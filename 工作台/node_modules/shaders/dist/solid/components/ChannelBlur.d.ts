...
import { ComponentProps } from '../../core/shaders/ChannelBlur';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'redIntensity' | 'greenIntensity' | 'blueIntensity'>> & {
