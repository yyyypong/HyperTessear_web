...
import { ComponentProps } from '../../core/shaders/Engraving';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'frequency' | 'angle' | 'center' | 'relief' | 'waviness' | 'contrast'>> & {
...
//# sourceMappingURL=Engraving.d.ts.map