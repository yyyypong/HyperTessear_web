...
import { ComponentProps } from '../../core/shaders/Plasma';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'density' | 'intensity' | 'contrast' | 'balance'>> & {
