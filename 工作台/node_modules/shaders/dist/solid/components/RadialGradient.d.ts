...
import { ComponentProps } from '../../core/shaders/RadialGradient';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'center' | 'radius' | 'repeat' | 'aspect' | 'skewAngle'>> & {
