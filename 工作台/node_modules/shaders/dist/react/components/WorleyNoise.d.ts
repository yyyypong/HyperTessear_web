...
import { ComponentProps } from '../../core/shaders/WorleyNoise';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'scale' | 'lacunarity' | 'persistence' | 'jitter' | 'contrast' | 'balance' | 'seed'>> & {
