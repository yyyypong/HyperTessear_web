...
import { ComponentProps } from '../../core/shaders/RectangularCoordinates';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'center' | 'scale' | 'intensity'>> & {
