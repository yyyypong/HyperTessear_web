...
import { ComponentProps } from '../../core/shaders/Circle';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'radius' | 'softness' | 'center' | 'strokeThickness'>> & {
