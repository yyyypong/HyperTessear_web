...
import { ComponentProps } from '../../core/shaders/Voronoi';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'scale' | 'seed' | 'edgeIntensity' | 'edgeSoftness'>> & {
