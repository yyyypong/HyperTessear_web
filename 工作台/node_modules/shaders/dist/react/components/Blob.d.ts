...
import { ComponentProps } from '../../core/shaders/Blob';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'softness' | 'highlightIntensity' | 'speed' | 'center'>> & {
