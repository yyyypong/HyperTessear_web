...
export const ROLE_DEFINITIONS = Object.freeze({
  governor: role('governor', '/workspaces/governor', 'protocol', ['governor.members.manage', 'protocol.modules.pause', 'psm.protocol.pause', 'revenue.treasury.set', 'nav.signer.manage']),
